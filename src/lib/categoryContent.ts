...
export const categoryContent: Record<CategorySlug, CategoryContent> = {
  racing: {
    ...
    metaHook: "تحدّ مهارات القيادة والسرعة على مضامير صعبة",
  },
  action: {
    intro:
    ...
    metaHook: "خوض المعارك المثيرة والمغامرات القتالية",
  },
  puzzle: {
    intro:
    ...
    metaHook: "حلّ ألغاز ذكية تختبر قدرتك على التفكير",
  },
  io: {
    intro:
    ...
    metaHook: "تنافس مع آلاف اللاعبين من حول العالم في الوقت ذاته",
  },
  girls: {
    intro:
    ...
    metaHook: "صمّم، البس، وأبدع في عالم البنات الجميل",
  },
  casual: {
    intro:
    ...
    metaHook: "متعة سريعة في جلسة قصيرة بدون أي تعقيد",
  },
  sports: {
    intro:
    ...
    metaHook: "العب على ملاعب كرة القدم والسلّة والتنس",
  },
  shooting: {
    intro:
    ...
    metaHook: "صوّب بدقّة وانتصر في معارك الـ FPS متعددة اللاعبين",
  },
};
