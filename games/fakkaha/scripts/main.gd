...
const LEVELS := [
    {"name": "الحِجر", "texture": preload("res://assets/levels/hegra_01.png"), "grid": 3, "shuffle": 3},
    {"name": "الدرعية", "texture": preload("res://assets/levels/diriyah_02.png"), "grid": 3, "shuffle": 6},
    {"name": "جدة التاريخية", "texture": preload("res://assets/levels/jeddah_03.png"), "grid": 3, "shuffle": 10},
    {"name": "رجال ألمع", "texture": preload("res://assets/levels/rijal_almaa_04.png"), "grid": 3, "shuffle": 14},
    {"name": "جزر فرسان", "texture": preload("res://assets/levels/farasan_05.png"), "grid": 4, "shuffle": 8},
    {"name": "واحة الأحساء", "texture": preload("res://assets/levels/alahsa_06.png"), "grid": 4, "shuffle": 14},
    {"name": "حافة العالم", "texture": preload("res://assets/levels/edge_world_07.png"), "grid": 4, "shuffle": 22},
    {"name": "قصر المصمك", "texture": preload("res://assets/levels/masmak_08.png"), "grid": 4, "shuffle": 32},
    {"name": "ورد الطائف", "texture": preload("res://assets/levels/taif_09.png"), "grid": 4, "shuffle": 46},
    {"name": "جبال السودة", "texture": preload("res://assets/levels/soudah_10.png"), "grid": 4, "shuffle": 60},
]
